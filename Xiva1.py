...
def water_sensor():
    ...
    mydb.commit()
    m_sensor_lbl_input_1.after(5000, water_sensor)
...
w_lbl_in_cub= Label(secondWindow, text='', font=('Arial', 18), bd=2, relief=SUNKEN, bg='white', fg='black', width=8)
